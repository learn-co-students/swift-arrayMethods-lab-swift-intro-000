...
for (num, day) in weekDays.enumerated() {
    print("\(num + 1) \(day)")
}
...
print("Array is empty: ", emptyArray.isEmpty)
...
print("Array is not empty: ", !funColors.isEmpty)
 ...
 */
// Error in exercise: daysOfTheWeek already includes the weekend. weekDays is a constant variable.
//weekDays.append(contentsOf: "Saturday")
//weekDays.append(contentsOf: "Sunday")
for day in daysOfTheWeek {
    print(day)
}
