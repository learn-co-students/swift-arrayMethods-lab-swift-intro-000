...
var daysOfTheWeek: [String] = ["mon","tue","wed","thr","fri"]
...
let weekDays = ["sun","mon","thu","wed","thu"]
for day in weekDays {
    print(day)
}
...
if funColors.isEmpty {
    print("fun color is empty")
} else {
    for color in funColors {
        print("funColors have \(color)!")
    }
}
...
var sizeOfDaysOfTheWeek = daysOfTheWeek.count
print(sizeOfDaysOfTheWeek)
...
var newDays = ["sun","sat"]
daysOfTheWeek.append(contentsOf: newDays)
print(daysOfTheWeek
)
/*: question7
