...
if emptyArray.isEmpty {print ("Empty Array is emmmmmmptyyyyyyyyy")}
...
if !reverseEmptyArray.isEmpty {print ("Reverse empty array is... not empty?")}
 ...
 */
daysOfTheWeek.insert (daysOfTheWeek.last!, at:0)
 ...
 */
for (i, c) in daysOfTheWeek.enumerated() {
    daysOfTheWeek[i] = c.lowercased()
}
