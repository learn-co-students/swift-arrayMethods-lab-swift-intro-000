...
var daysOfTheWeekLCo = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"]

for day in daysOfTheWeekLCo {
...
let weekDaysLCo = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"]
...
let funColorsLCo = ["red", "blue", "green"]
...
print("daysOfTheWeek has \(daysOfTheWeekLCo.count) elements in it.")
...
daysOfTheWeekLCo.append("Saturday")
daysOfTheWeekLCo.append("Sunday")
...
let indexOfSunday = daysOfTheWeekLCo.index(of: "Sunday")!

daysOfTheWeekLCo.remove(at: indexOfSunday)

daysOfTheWeekLCo.insert("Sunday", at: 0)
