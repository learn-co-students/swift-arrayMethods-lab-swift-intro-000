...
if !funColors.isEmpty {
    print("We have fun colors")
} else {
    print("We have the boring colors")
}
...
//can also daysOfTheWeek.index(of: "Sunday) Which will search for wherever Sunday is rather than knowing the location
print(daysOfTheWeek)
