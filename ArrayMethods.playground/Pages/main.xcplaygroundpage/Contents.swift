...
for (index,item) in numDaysOfTheWeek.enumerated() {
    print("\(index+1). \(item)")
}
...
print("It is fine to change this array")
}
...
for (index,item) in daysOfTheWeek.enumerated() {
    print("\(index+1). \(item)")
}
