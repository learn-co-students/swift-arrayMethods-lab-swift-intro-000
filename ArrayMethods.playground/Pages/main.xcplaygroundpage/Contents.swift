 ...
 */
daysOfTheWeek.count
print("The number of days in a week is \(daysOfTheWeek.count)")
...
for day in weekend {
    ...
    print("appended \(day) to the days")
}
