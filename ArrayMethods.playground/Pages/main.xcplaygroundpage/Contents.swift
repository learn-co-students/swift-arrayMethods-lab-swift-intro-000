 ...
 */
var daysOfTheWeek = ["Monday", "Tuesday", "Wednesday", "Thirsday", "Friday"]
 ...
 */
let weekDays = ["Monday", "Tuesday", "Wednesday", "Thirsday", "Friday"]
...
let funColors: [String] = ["red", "green", "blue"]
 ...
 */
daysOfTheWeek.insert(daysOfTheWeek.remove(at: 6), at: 0)
