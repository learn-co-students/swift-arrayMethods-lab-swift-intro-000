 ...
 */
var daysOfTheWeek: [String] = ["Monday", "Tuesday", "Wednesday", "Thrusday", "Friday"]

for cell in daysOfTheWeek   {
 ...
 */
let numDaysOfTheWeek = ["Monday", "Tuesday", "Wednesday", "Thrusday", "Friday"]

for (index,cell) in numDaysOfTheWeek.enumerated() {
 ...
 */
var reverserEmptyArray: [String] = []

if !reverserEmptyArray.isEmpty  {
    print("The reverse array has content")
} else {
    print("The array is empty")
}
...
for (index,mem) in daysOfTheWeek.enumerated() {
    print("\(index + 1) \(mem)")
}
 ...
 */
for (index,mem) in daysOfTheWeek.enumerated() {
    daysOfTheWeek[index] = (mem.lowercased())
}
print(daysOfTheWeek)
/*: question9
