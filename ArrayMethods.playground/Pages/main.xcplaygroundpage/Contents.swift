...
if emptyArray.isEmpty {
    print("The array called emptyArray is empty.")
} else {
    print("The array called emptyArray is not empty.")
}
 ...
 */
let amount = daysOfTheWeek.count
print("The array called daysOfTheWeek has \(amount) elements.")
 ...
 */
let removeThenAdd = daysOfTheWeek.remove(at: 6)
daysOfTheWeek.insert(removeThenAdd, at: 0)
