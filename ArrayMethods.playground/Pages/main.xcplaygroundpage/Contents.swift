...
for (position, day) in weekDays.enumerated(){
    print("\(position): \(day)")
}
/*: question4
...
// Question can append take multiple args? so could I have done daysOfTheWeek.append("Saturday", "Sunday")? Assuming no the playground gave me an error.
/*: question7
