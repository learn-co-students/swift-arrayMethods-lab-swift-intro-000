 ...
 */
let weekDays: [String] = ["Monday", "Tuesday", "Wednesday", "Thrusday", "Friday"]

for day in weekDays {
    print(weekDays.index(of: day)!, day)
...
if funColors.isEmpty {
    print("funColors Array is Empty")
} else {
    print("funColors Array is not Empty")
}
 ...
 */
daysOfTheWeek.insert("Satruday", at:5)
