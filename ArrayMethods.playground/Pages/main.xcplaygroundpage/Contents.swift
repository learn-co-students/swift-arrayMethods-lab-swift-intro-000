...
for (dayNumber, day) in weekDays.enumerated() {
    print("Day \(dayNumber + 1) is \(day)")
}
 ...
 */
let funColours = ["red", "blue", "green"]
if !funColours.isEmpty {
    print("The array is not empty")
} else {
    print("The array is empty")
}
 ...
 */
var numberOfDaysOfTheWeek = daysOfTheWeek.count
print("\(numberOfDaysOfTheWeek)")
...
for (index, day) in daysOfTheWeek.enumerated() {
    print("\(daysOfTheWeek[index].lowercased())")
}
