...
for (day, index) in weekDays.enumerated() {
    print("\(index + 1). \(day)")
}
/*: question3
...
if !funColors.isEmpty {
    print("Fun colors are awesome.  Array contains colors")
} else {
    print("There are no fun colors.  Array is empty")
}
/*: question5
 ### 5. Find out the size of the 'daysOfTheWeek' array created earlier, and print it to the screen.
 */
print("daysOfTheWeek has \(daysOfTheWeek.count) total days)
/*: question6
